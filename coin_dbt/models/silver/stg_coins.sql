...
parsed as (
    select
        ...
        try_cast(json_value(e.coin_json, '$.current_price') as decimal(18,8)) as current_price,
        try_cast(try_cast(json_value(e.coin_json, '$.market_cap') as float) as bigint) as market_cap,
        try_cast(try_cast(json_value(e.coin_json, '$.total_volume') as float) as bigint) as total_volume,
        try_cast(json_value(e.coin_json, '$.price_change_percentage_24h') as decimal(18,8)) as price_change_percentage_24h,
